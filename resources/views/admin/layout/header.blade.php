    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="berita" class="collapse" aria-labelledby="berita" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ asset('admin/berita') }}"><i class="fa fa-newspaper"></i> Data Wisata</a>
            <a class="collapse-item" href="{{ asset('admin/berita/tambah') }}"><i class="fa fa-plus"></i> Tambah Wisata</a>
            <a class="collapse-item" href="{{ asset('admin/kategori') }}"><i class="fa fa-tags"></i> Kategori Wisata</a>
          </div>
        </div>
      </li>
      <!-- Download -->
      ...
      <li class="nav-item">
        ...
        <div id="Galeri" class="collapse" aria-labelledby="Galeri" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ asset('admin/galeri') }}"><i class="fa fa-newspaper"></i> Data Wisata</a>
            <a class="collapse-item" href="{{ asset('admin/galeri/tambah') }}"><i class="fa fa-plus"></i> Tambah Wisata</a>
            <a class="collapse-item" href="{{ asset('admin/kategori_galeri') }}"><i class="fa fa-tags"></i> Kategori Wisata</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
