...
<div class="col-md-6">
    ...
    <div class="form-group">
    <label>URL Youtube <i class="fa fa-twitter"></i></label>
   <input type="text" name="twitter" placeholder="http://youtube.com/kode youtube" value="<?php echo $site->twitter ?>" class="form-control">
    </div>

    <div class="form-group">
    <label>Nama Youtube <i class="fa fa-facebook"></i></label>
    <input type="text" name="nama_twitter" placeholder="Nama akun Youtube" value="<?php echo $site->nama_twitter ?>" class="form-control">
    </div>
