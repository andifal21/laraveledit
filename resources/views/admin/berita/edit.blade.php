...
<div class="row form-group">
  <label class="col-md-3">Judul Destinasi Wisata</label>
  <div class="col-md-6">
...
<div class="row form-group">
  <label class="col-md-3">Icon Destinasi Wisata</label>
  <div class="col-md-6">
...
<div class="row form-group">
  <label class="col-md-3">Jenis &amp; Kategori Destinasi Wisata</label>
  <div class="col-md-3">
