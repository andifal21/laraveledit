...
<div class="row form-group">
  <label class="col-md-3">Judul Wisata</label>
  <div class="col-md-6">
    <input type="text" name="judul_berita" class="form-control form-control-lg" placeholder="Judul Wisata" required="required" value="{{ old('judul_berita') }}">
  </div>
</div>

<div class="row form-group">
  <label class="col-md-3">Icon Wisata</label>
  <div class="col-md-6">
    <input type="text" name="icon" class="form-control" placeholder="Icon Wisata" value="{{ old('icon') }}">
...
<div class="row form-group">
  <label class="col-md-3">Kategori Wisata</label>
  <div class="col-md-3">
    <select name="jenis_berita" class="form-control select2">
     <option value="Berita">Wisata</option>
