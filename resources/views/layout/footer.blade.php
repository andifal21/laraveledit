...
<script>
  ...
  <footer id="footer" >
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            <h4>Link Lanjutan..</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="https://www.kominfo.go.id">Kominfo</a></li>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="https://forms.gle/tL4bDCFKyiUxvkyu5">Feedback</a></li>
            </ul>
          </div>
    ...
    <div class="container">
      ...
      <div class="credits">
        Developed by <a href="https://diskominfo.soppengkab.go.id/">DISKOMINFO KAB.SOPPENG</a>
      </div>
    </div>
  </footer><!-- End Footer -->
